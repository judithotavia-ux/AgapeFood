...
// SUPER_ADMIN (dono da plataforma) - ver todas as empresas, indicadores de cada uma, cadastrar
// uma nova em nome do cliente (escolhendo o plano dela) e "entrar" em qualquer uma delas
router.get('/', autenticar, exigirPapel('SUPER_ADMIN'), listarTodas);
router.get('/indicadores', autenticar, exigirPapel('SUPER_ADMIN'), indicadores);
